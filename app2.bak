...
//float bma400_data[EI_CLASSIFIER_DSP_INPUT_FRAME_SIZE];
...
//  GPIO_PinOutClear(ON_OFF_FPGA_PORT, ON_OFF_FPGA_PIN);
//  GPIO_PinOutClear(ICE_MOSI_PORT, ICE_MOSI_PIN);
  ...
  GPIO_PinOutClear(ICE_MOSI_PORT, ICE_MOSI_PIN);
//  GPIO_PinOutSet(ICE_MOSI_PORT, ICE_MOSI_PIN);
//  GPIO_PinOutSet(ON_OFF_FPGA_PORT, ON_OFF_FPGA_PIN);
...
//      sl_sleeptimer_delay_millisecond(1);
//      EMU_EnterEM1();
//      EMU_EnterEM2(true);//EMU_EnterEM1
//      GPIO_PinOutClear(ICE_MOSI_PORT, ICE_MOSI_PIN);
...
//  vg_bma400_fifo_conf.param.int_conf.pin_conf = BMA400_INT_PUSH_PULL_ACTIVE_1;
...
//      out_ptr[i] = (bma400_data + offset)[i];
//  }
...
//  GPIO_PinOutClear(SPI_CPU_CS_PORT,SPI_CPU_CS_PIN);
  ...
  while (i8_retval == BMA400_OK)
    {
      ...
      if (u16_int_status & BMA400_ASSERTED_FIFO_WM_INT)// BMA400_ASSERTED_DRDY_INT  BMA400_ASSERTED_FIFO_FULL_INT
        {
          GPIO_PinOutSet(ICE_MOSI_PORT, ICE_MOSI_PIN);
//          app_log("start idx: %d\t",vg_bma400_fifo_frame.accel_byte_start_idx);
//                    GPIO_PinOutSet(ICE_MOSI_PORT, ICE_MOSI_PIN);
//                    GPIO_PinOutSet(ON_OFF_FPGA_PORT, ON_OFF_FPGA_PIN);

          bma400_get_fifo_data(&vg_bma400_fifo_frame,&vg_bma400_handle);
//          app_log("get fifo data idx: %d\t\r\n",vg_bma400_fifo_frame.accel_byte_start_idx);
...
//          app_log("extract accel idx: %d\r\n",vg_bma400_fifo_frame.accel_byte_start_idx);
//          if (accel_frames_req)
//            {
//
//              //              app_log("\r\nExtracted FIFO frames : %d\r\n", accel_frames_req);
//              //
//              //              if (vg_bma400_fifo_frame.fifo_sensor_time)
//              //              {
//              //                  app_log("FIFO sensor time : %.4fs\n", (float)(vg_bma400_fifo_frame.fifo_sensor_time) * SENSOR_TICK_TO_S);
//              //              }
//            }
//
          runInference();
